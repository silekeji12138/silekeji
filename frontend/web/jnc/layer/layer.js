		...
		if(t = t || {}, t.photos) {
			...
			l.imgprev = function(e) {
				...
				r.close(l.loadi), l.index = r.open(i.extend({
					...
					content: '<div class="layui-layer-phimg"><img src="' + d[u].src + '" alt="' + (d[u].alt || "") + '" layer-pid="' + d[u].pid + '"><div class="layui-layer-imgsee">' + (d.length > 1 ? '<span class="layui-layer-imguide" style="display:block;"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev" style="display:block;"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span>' : "") + '<div class="layui-layer-imgbar" style="display:' + (a ? "block" : "block") + '"><span class="layui-layer-imgtit"><a href="javascript:;">' + (d[u].alt || "") + "</a><em>" + l.imgIndex + "/" + d.length + "</em></span></div></div></div>",
