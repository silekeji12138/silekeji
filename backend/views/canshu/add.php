...
<section class="body-content">
    ...
    <!--当前位置 end-->
    <br />
    <form action="<?=\yii\helpers\Url::to(['canshu/add','classid'=>$classid])?>" method="post">
    <table class="table table-info cs-table">
        <tr>
            <th width="60">参数标题</th>
            <td>

                <input type="text" class="input" name="u1"/>
            </td>
        </tr>
        <tr>
            <th>参数</th>
            <td>
                <div class="enterwords-box fl">
                    ...
                    <input type="text" class="enterinput" name="u2"/>
                </div>
                <span class="help-block">字段类型必填，格式为数据表格式。例：varchar</span>
            </td>
        </tr>
        <tr>
            <th>上级标题</th>
                ...
                <div>
                    ...
                    <select name="classid" id="">
                        ...
                        <?php foreach ($parents as $v):?>
                            <option <?=$classid==$v->id?'selected':''?> value="<?=$v->id?>"><?=$v->u1?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" class="input" name="u4"/>
            </td>
        </tr>
        <tr>
            <th></th>
