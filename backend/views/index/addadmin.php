...
<section class="body-content">
    ...
    <!--当前位置 end-->
    <br />
    <form action="<?=\yii\helpers\Url::to(['index/add-admin'])?>" method="post">
    <table class="add-table">
        <tr>
            <th><em class="ficon ficon-riqi"></em></th>
            <td>
                <div class="pos-relative">
                    <input type="text" class="add-input" name="username"/>
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="text" class="add-input" name="really_name"/>
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="password" class="add-input" name="password"/>
        ...
        <tr>
            ...
            <td>
                <div class="radio radio-info radio-inline">
                    <input type="radio" id="nan" name="sex" value="1" checked="checked">
                    <label for="nan"> 男 </label>
                </div>
                &nbsp;&nbsp;
                <div class="radio radio-info radio-inline">
                    <input type="radio" id="nv" value="2" name="sex">
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="text" class="add-input" name="mobile"/>
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="email" class="add-input" name="email"/>
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="text" class="add-input" name="qq"/>
        ...
        <tr>
            ...
            <td>
                <div class="pos-relative">
                    <input type="text" class="add-input" name="address"/>
        ...
        <tr>
            <th></th>
            <td>
                <button style="cursor: pointer;" type="submit" href="#" class="btn btn-blue marb-20"><em class="ficon ficon-queren"></em> 确认操作</button>
